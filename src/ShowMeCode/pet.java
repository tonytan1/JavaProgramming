...
public class pet {
    public static void main(String[] args){
        ...
        System.out.print("witch type of ShowMeCode.pet do you prefer?\n"+
        ...
        if(obj instanceof Dog){
            ...
            //of the ShowMeCode.Dog class or a class descended from the ShowMeCode.Dog class.
