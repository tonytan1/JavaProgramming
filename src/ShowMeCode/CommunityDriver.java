...
public class CommunityDriver {
    public static void main(String[] args){
        ...
        System.out.println("ShowMeCode.Citizen\tFriends");
        for(Integer id: citizens.keySet()){
            //use ShowMeCode.Citizen's toString method to display citizen info.
        ...
        System.out.println("ShowMeCode.Citizen\tDelay");
